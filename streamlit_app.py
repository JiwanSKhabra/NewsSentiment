...
# === Data Source Toggle ===
data_source = st.sidebar.selectbox("🗂 Select News Source", ["NYT", "GNews"])
table_name = "nyt_articles" if data_source == "NYT" else "gnews_articles"

# === Load and Cluster ===
df = load_articles(table_name)
...
# === Results Display ===
st.markdown(f"### 🔍 Showing {len(filtered_df)} Articles from **{data_source}**")
st.dataframe(
